...
# df = pd.read_excel('LHS_WTP_sugarbeet_org_0.xlsx')
...
filename = r"N:\agpo\work1\Shang\Robot\RobotPaperGit\Result\Mean-MC16384.xlsx"
...
#%%
# param_1 = 'unskilled_labor_wage' # must be a variable in the list of variables
# param_2 = 'weeding_efficiency'   # must be a variable in the list of variables
